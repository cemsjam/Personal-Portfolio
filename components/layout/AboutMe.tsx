...
const AboutMe = () => {
	...
	return (
		<section className="max-w-[80ch]">
			<h3 className="text-3xl text-center font-bold mb-4">{t("title")}</h3>
			<div className="dark:text-white">
				{locale === "en" && (
					<>
						<p className="mb-3">
							After graduating with a degree as a <span className="font-bold">Tourist Guide</span>, I decided to pursue
							my passion for programming. I am a <span className="font-bold">self-taught front-end developer</span> and
							learned enough to land my <span className="font-bold">first job within 6 months.</span>{" "}
							<span className="italic">My favorite part of programming</span> is the problem-solving aspect.{" "}
							<span className="underline">I love the feeling of finally figuring out a solution to a problem.</span> My
							core stack is <span className="font-bold">React.js, Next.js</span>. I am also familiar with TypeScript. I
							am always looking to learn new technologies. I am currently looking for a{" "}
				...
				{locale === "tr" && (
					<>
						<p className="mb-3">
							...
							. Temel teknolojilerim <span className="font-bold">React.js ve Next.js</span>. Ayrıca TypeScript bilgim de
							var. Her zaman yeni teknolojiler öğrenmeye açık biriyim. Şu anda{" "}
						...
						<p>
							...
							gitar çalmaktan keyif alıyorum. Ayrıca <span className="font-bold">yeni şeyler öğrenmekten</span> de büyük
							keyif alıyorum.
						</p>
					</>
				)}
